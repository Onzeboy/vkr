...
public class ChatController {
    ...
    public ResponseEntity<?> sendMessage(
        ...
        try {
            ...
            User user = userService.getCurrentUser();
            if (user == null) {
                log.error("Неавторизованный доступ для отправки сообщения пользователем");
            ...
            log.error("Ошибка при отправке сообщения пользователем для ticketId {}: {}", ticketId, e.getMessage());
